...
import com.bmobile.workingspace.ui.components.WorkingSpaceTopAppBar
import com.bmobile.workingspace.R
import com.bmobile.workingspace.ui.components.SettingsDropdown
import com.bmobile.workingspace.ui.components.SettingsSection
import com.bmobile.workingspace.ui.components.SettingsSlider
import com.bmobile.workingspace.ui.components.SettingsSwitch
        ...
        LazyColumn(
            ...
            item {
                ...
                SettingsSection(title = stringResource(R.string.display_gestures)) {
                    ...
                    SettingsSlider(
                        title = stringResource(R.string.workingspace_menu_opacity_title),
...
private fun loadInstalledApps(context: Context): List<AppInfo> {
    ...
    return pm.queryIntentActivities(intent, PackageManager.ResolveInfoFlags.of(0))
        .mapNotNull { resolveInfo ->
            ...
            if (HiddenAppPackages.isHidden(packageName)) return@mapNotNull null
            try {
