...
package com.bmobile.workingspace.ui.screens
...
import com.bmobile.workingspace.ui.components.AddGameTile
import com.bmobile.workingspace.ui.components.FeaturedGameCard
import com.bmobile.workingspace.ui.components.GameTile
import com.bmobile.workingspace.ui.components.HubBackground
import com.bmobile.workingspace.ui.components.gameModeLabel
import com.bmobile.workingspace.ui.viewmodel.RegisteredGame
import com.bmobile.workingspace.ui.viewmodel.SettingsViewModel
import com.bmobile.workingspace.utils.HiddenAppPackages
        ...
        withContext(Dispatchers.IO) {
            ...
            val apps = pm.queryIntentActivities(intent, PackageManager.ResolveInfoFlags.of(0))
                .mapNotNull { ri ->
                    ...
                    if (HiddenAppPackages.isHidden(ai.packageName)) return@mapNotNull null
                    try {
...
@Composable
private fun WorkingSpaceBanner(modifier: Modifier = Modifier) {
    val context = LocalContext.current
...
private const val GITHUB_URL = "https://github.com/BMobileOS"
private const val TRANSLATE_URL = "https://crowdin.com/project/lineageos"
private const val WEBSITE_URL = "https://bmobile.dev"
private const val SUPPORT_EMAIL = "support@bmobile.dev"
