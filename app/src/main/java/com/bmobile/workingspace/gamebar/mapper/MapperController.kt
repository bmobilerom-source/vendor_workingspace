...
package com.bmobile.workingspace.gamebar.mapper
...
import com.bmobile.workingspace.utils.OverlayComposeInitializer
...
class MapperController(
    ...
    fun enterEditMode() {
        ...
        try {
            ...
            OverlayComposeInitializer.onAttachedToWindow(overlayView!!)
    ...
    private fun dismissEdit() {
        ...
        overlayView?.let { view ->
            ...
            OverlayComposeInitializer.onDetachedFromWindow(view)
        }
        overlayView = null
        onEditFinished?.invoke()
    }
