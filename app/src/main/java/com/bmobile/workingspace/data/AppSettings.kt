 ...
 */
package com.bmobile.workingspace.data
...
import com.bmobile.workingspace.utils.dp
import com.bmobile.workingspace.utils.statusbarHeight
...
class AppSettings @Inject constructor(private val context: Context) {
    ...
    companion object {
        const val KEY_AUTO_BRIGHTNESS_DISABLE = "workingspace_auto_brightness_disabled"
        const val KEY_3SCREENSHOT_DISABLE = "workingspace_tfgesture_disabled"
        const val KEY_STAY_AWAKE = "workingspace_stay_awake"
        const val KEY_DANMAKU_NOTIFICATION_MODE = "workingspace_danmaku_notification_mode"
        const val KEY_CALLS_MODE = "workingspace_calls_mode"
        const val KEY_RINGER_MODE = "workingspace_ringer_mode"
        const val KEY_LOCK_GESTURE = "workingspace_lock_gesture"
        const val KEY_MENU_OPACITY = "workingspace_menu_opacity"
        ...
        const val KEY_ICON_IDLE_ALPHA = "workingspace_icon_idle_alpha"
        const val KEY_AUTO_DND = "workingspace_auto_dnd"
    }
}
